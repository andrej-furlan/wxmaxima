...
private:
  ...
  OwningCellPtr HandleNullPointer(OwningCellPtr cell);
  ...
  */
  ...
  OwningCellPtr ParseSpaceTag(wxXmlNode *WXUNUSED(node)){return OwningCellPtr{new TextCell(NULL, m_configuration, wxT(" "))};}
